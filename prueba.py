...
class formulario:
    ...
    def crear_solapa_socio(self):
        ...
        self.cargasocio=tk.StringVar
        self.entrynumerodesocio=tk.Entry(self.labelframe1, textvariable= self.cargasocio)
        self.entrynumerodesocio.grid (column=1, row=1, padx=4, pady=4)

        self.button1=ttk.Button(self.pagina1, text="confirmar", command = self.insertar_datos)
